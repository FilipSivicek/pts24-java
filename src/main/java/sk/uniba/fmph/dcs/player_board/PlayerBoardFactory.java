...
public final class PlayerBoardFactory {
     ...
     *            The number of figures the player starts with.
     * @param initialFood
     *            The amount of food the player starts with.
     *
     ...
     *
     * @return A new instance of the {@link PlayerBoard} and {@link PlayerBoardGameBoardFacade} pair initialized with
     *         default values for figures and food.
     */
